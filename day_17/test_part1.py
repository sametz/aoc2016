from part1 import read_input, open_doors, in_bounds, next_states, main
...
def test_main():
    assert main("ihgpwlah") == "DDRRRD"
    assert main("kglvqrro") == "DDUDRLRRUDRD"
    assert main("ulqzkmiv") == "DRURDRUDDLLDLUURRDULRLDUUDDDRR"
